        ...
        <div className="md:flex">
          <div className="flex flex-col items-center">
            <p>
              ...
              <span className="text-xl p-2 text-shadow dark:text-[whitesmoke] dark:shadow-indigo-900/50">
                Aung Mon
              </span>
            </p>
            <p className="text-slate-800 dark:text-[whitesmoke] text-l mt-1 px-8">
              Specializes in PERN, MERN stack, NEXTJS and can easily adapt to
              new technologies.
            </p>
            <p className="text-2xl my-4 text-center dark:text-[whitesmoke]">
